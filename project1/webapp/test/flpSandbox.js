			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TPproject1-display": {
								"semanticObject": "TPproject1",
								"action": "display",
								"description": "Projekt für Lernzwecke.",
								"title": "Training Project",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=TP.project1",
									"url": sap.ui.require.toUrl("TP/project1")
								}
							}
						}
					}
